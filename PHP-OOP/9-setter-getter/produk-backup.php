...
class Produk
{
    ...
    // Membuat property dengan menggunakan visibility private agar hanya bisa diakses di dalam class itu sendiri
    private $harga = 0;
    // Membuat property dengan menggunakan visibility protected agar hanya bisa diakses di dalam class itu sendiri dan turunannya
    protected $diskon = 0;
    ...
    // Membuat method getHarga untuk mengambil nilai property harga yang bersifat private untuk dikurangi dengan diskon
...
class Komik extends Produk
{
    ...
    // Membuat method untuk mengubah nilai property diskon
