...
function registrasi($data)
{
    ...
    // tangkap data yang diinputkan oleh user ke dalam variabel
    // membersihkan karakter tertentu agar tidak masuk ke dalam database menggunakan fungsi stripslashes
    // fungsi stripslashes stripslashes() dalam PHP digunakan untuk menghapus backslashes (\) dari string. Backslashes akan dihapus dari karakter-karakter tertentu seperti \', \", dan \\ untuk mengubahnya kembali menjadi '', "", dan \ secara berturut-turut.
    // paksa inputan username user menjadi huruf kecil semua menggunakan strtolower
    // strtolower merupakan fungsi untuk mengubah string menjadi huruf kecil semua setiap hurufnya
    $username = strtolower(stripslashes($data["username"]));
    // untuk memasukkan beberapa karakter tertentu semisal tanda kutip ke dalam database, maka gunakan fungsi mysqli_real_ascape_string
    // fungsi mysqli_real_escape_string digunakan dalam PHP untuk mengamankan string yang akan digunakan dalam query SQL dengan cara menambahkan backslashes pada karakter tertentu yang mungkin berbahaya atau memiliki arti khusus dalam SQL, seperti single quote ('), double quote ("), backslash (\), dan NULL.
    // rumus untuk fungsi mysqli_real_escape_string($koneksi, $user_input);
    ...
    // enkripsi password
    // password_hash digunakan untuk melakukan enkripsi
    // rumus untuk fungsi password_hash($data_yang_mau_dienkripsi, PASSWORD_DEFAULT algoritma yang dipilih sesuai dengan php dan terus berubah sesuai update-an php)
